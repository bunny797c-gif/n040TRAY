...
const FROM = process.env.RESEND_FROM || 'The Tray Microgreens <hello@thetraymicrogreens.in>';
  ...
  <html><body style="margin:0;padding:0;background:#f5f5f5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;color:#333">
    <div style="max-width:600px;margin:0 auto;padding:24px">
      <div style="background:#4a7c59;color:#fff;padding:28px 24px;border-radius:14px 14px 0 0;text-align:center">
        <h1 style="margin:0;font-size:24px;font-weight:700;letter-spacing:0.3px">The Tray Microgreens</h1>
        <p style="margin:6px 0 0;opacity:0.85;font-size:14px">Harvested Today. On Your Plate Tomorrow.</p>
      </div>
      ...
      <p style="text-align:center;font-size:11px;color:#aaa;margin-top:20px">
        © ${new Date().getFullYear()} The Tray Microgreens · Bengaluru, Karnataka
      </p>
    </div>
  </body></html>`;
}
